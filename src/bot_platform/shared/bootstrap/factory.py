...
def create_life_application_components(settings: Settings) -> tuple[Application, LifeBotService]:
    ...
    app.add_handler(CommandHandler("hapus", controller.delete_command))
    app.add_handler(CommandHandler("view", controller.view_command))
    app.add_handler(CommandHandler("read", controller.view_command))
    app.add_handler(CommandHandler("detail", controller.view_command))
    app.add_handler(CommandHandler("lihat", controller.view_command))
    app.add_handler(CommandHandler("edit", controller.edit_command))
    app.add_handler(CommandHandler("ubah", controller.edit_command))
    app.add_handler(MessageHandler(filters.VOICE, controller.voice_message))
    app.add_handler(MessageHandler(filters.TEXT & ~filters.COMMAND, controller.text_message))
    app.add_error_handler(controller.application_error_handler)
